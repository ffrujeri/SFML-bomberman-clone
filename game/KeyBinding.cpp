...
: mKeyMap()
{
	setControlPreconfiguration(controlPreconfiguration);
}
...
void KeyBinding::setControlPreconfiguration(int i) {
	...
	if (i == 1)
	{
		...
		mKeyMap[sf::Keyboard::Space] = PlayerAction::PlaceBomb;
		mKeyMap[sf::Keyboard::M]     = PlayerAction::GuidedBomb;
	}
	else if (i == 2)
	{
		// Player 2
		...
		mKeyMap[sf::Keyboard::F] = PlayerAction::PlaceBomb;
		mKeyMap[sf::Keyboard::R] = PlayerAction::GuidedBomb;
	}
}
